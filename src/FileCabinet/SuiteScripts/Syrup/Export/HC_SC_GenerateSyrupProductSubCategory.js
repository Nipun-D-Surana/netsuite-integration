...
define(['N/task', 'N/search', 'N/record', 'N/error'], function (task, search, record, error) {
    function execute(context) {
        try {
            var searchId = 'customsearch_group_product_sub_category'; // Saved Search Id which will export products
            ...
            var fileName = 'product_group_sub_category_' + formattedDate + '.csv';
